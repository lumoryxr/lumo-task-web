...
- [ ] **`docs/business/marketing/good-first-issues.md` → real GH issues** — re-verify each is still open/unbuilt against current code, then file the still-valid ones (labels `good first issue`, `help wanted`). *Needs Jalen's OK to post publicly — see Blocked list.*
...
- [ ] Fill the 5 open decisions in `docs/business/marketing/launch-plan.md` §8, then finalize the §9 copy drafts (PH / Show HN / build-in-public / r/SideProject / FAQ). **Blocked on Jalen** — see below.
...
- [x] **`.github/` hygiene** — `.github/SECURITY.md` (responsible-disclosure via GitHub private reporting), `.github/CODE_OF_CONDUCT.md` (Contributor Covenant 2.1). Standard, docs-only. *(2026-08-16)*
...
- [x] **`docs/business/planning/growth-opportunities.md` → ROADMAP hand-off** — added a "Growth-lever candidates" sub-section to `docs/product/roadmap.md` Phase 3: A1→extends #171, A2/A3/C1→new propose-only entries, B1→#170, B2→#174+#171; B3 is Phase-1 polish (not innovative), left out by design. Growth doc annotated with the hand-off mapping. Propose-only, nothing built. *(2026-08-20)*
...
- 2026-08-16: Shipped `.github/SECURITY.md` + `.github/CODE_OF_CONDUCT.md` (community-health completeness; disclosure/enforcement routed through GitHub private vulnerability reporting, consistent with the project's no-personal-email contact policy). Section-C `.github/` hygiene item done.
