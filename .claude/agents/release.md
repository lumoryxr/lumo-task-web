...
4. **Roadmap** — update `docs/product/roadmap.md`: move the shipped feature from Near-Term into Current State, refresh "Last updated", and reflect what the next milestone is.
